  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {/* Modal */}
        <motion.div
          className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden relative z-[9999] pointer-events-auto"
        ...
        >
          ...
          <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-blue-50 to-purple-50">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Modify task status and add comments</p>
              </div>
            </div>
            <button
          ...
          <div className="flex flex-col lg:flex-row h-[calc(90vh-120px)]">
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-600">Current: {task.status}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {statusOptions.map((option) => {
                    ...
                    const getButtonClasses = () => {
                      if (isSelected) {
                        switch (option.value) {
                          case 'To Do': return 'bg-gray-100 text-gray-700 border-gray-700 shadow-lg';
                          case 'In Progress': return 'bg-blue-100 text-blue-700 border-blue-700 shadow-lg';
                          case 'Review': return 'bg-amber-100 text-amber-700 border-amber-700 shadow-lg';
                          case 'Completed': return 'bg-green-100 text-green-700 border-green-700 shadow-lg';
                          default: return 'bg-gray-100 text-gray-700 border-gray-700 shadow-lg';
                        }
                      }
                      return 'border-gray-200 hover:border-gray-300 hover:shadow-md';
                    };
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          <OptionIcon className={`w-5 h-5 ${isSelected ? 'text-current' : 'text-gray-400'}`} />
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 w-full sm:w-auto">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all flex items-center justify-center space-x-2"
                    disabled={loading}
                  >
                    {loading ? (
                      <>
            ...
            <div className="w-full lg:w-96 bg-gradient-to-br from-blue-50 to-purple-50 border-t lg:border-l lg:border-t-0 border-gray-200">
              <div className="p-4">
                <h4 className="text-lg font-semibold text-gray-900 mb-4">Status Preview</h4>
                
                {/* Status Card */}
                <div className="bg-white rounded-xl p-6 shadow-lg mb-4">
                  <div className="flex items-center justify-center mb-4">
                    <div className={`w-20 h-20 rounded-full flex items-center justify-center ${
                      selectedStatus === 'To Do' ? 'bg-gray-100 text-gray-700' :
                      selectedStatus === 'In Progress' ? 'bg-blue-100 text-blue-700' :
                      selectedStatus === 'Review' ? 'bg-amber-100 text-amber-700' :
                      selectedStatus === 'Completed' ? 'bg-green-100 text-green-700' :
                  ...
                  <div className="text-center">
                    <h5 className="text-xl font-semibold text-gray-900 mb-2">{selectedStatus}</h5>
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm">
                  <h5 className="font-medium text-gray-900 mb-3">Workflow Progress</h5>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl font-semibold text-gray-900">Task History</h3>
                    <button
