...
export default function TaskCard({
  ...
  return (
    <motion.div
      ref={setNodeRef}
      style={style}
      className={`group relative bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-xl border border-gray-200/60 dark:border-slate-700/60 shadow-sm hover:shadow-xl dark:shadow-slate-900/50 transition-all duration-300 cursor-pointer overflow-hidden h-auto min-h-[160px] w-full ${(isDragging || isDraggingCard) ? 'shadow-2xl scale-105 rotate-2' : 'hover:scale-[1.02] hover:-translate-y-1'
        }`}
      layout
      ...
      <div className="relative p-5">
        ...
        <div className="mb-3">
          ...
          <div className="flex items-center justify-between gap-2 mb-2">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              {assignee && (
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  ...
                  <span className="font-medium text-gray-700 dark:text-gray-300 text-xs truncate max-w-[70px] hidden sm:inline">
                    {assignee.name}
                  </span>
                </div>
              )}
              ...
              {task.reporter && task.reporter.name && task.reporter.name !== assignee?.name && (
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <span className="font-medium text-gray-600 dark:text-gray-400 text-xs truncate max-w-[60px] hidden sm:inline">
            ...
            {/* Efforts/Points */}
            {efforts_in_days && (
              <div className="flex items-center gap-1 px-2 py-1 rounded-lg bg-emerald-50/50 dark:bg-emerald-500/10 border border-emerald-100/50 dark:border-emerald-500/20 backdrop-blur-sm flex-shrink-0">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              {task.project && (
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <span className="font-medium text-gray-600 dark:text-gray-400 truncate max-w-[60px]">
                    {task.project.name}
                  </span>
                </div>
              )}
